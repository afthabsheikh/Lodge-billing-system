...
class LodgeTrackApp:
    ...
    def create_buttons(self):
        ...
        button_frame = tk.Frame(self.root, bg="#AEE2FF")
        button_frame.grid(row=0, column=0, padx=10, pady=10, sticky="nsew")

        self.root.grid_rowconfigure(0, weight=1)
        self.root.grid_columnconfigure(0, weight=1)

        title_label = tk.Label(button_frame, text="LodgeTrack", font=("Helvetica", 20,"bold"), bg="#AEE2FF", fg="black")
        ...
        center_frame = tk.Frame(button_frame, bg="#AEE2FF")
        center_frame.grid(row=2, column=0, pady=10)

        self.add_info_button = tk.Button(center_frame, text="Add Customer Details", command=self.add_info,
                                         bg="#795548", fg="white", padx=10, pady=5, width=15, height=1, bd=2, relief=tk.FLAT)
        self.add_info_button.grid(row=2, column=1, pady=10, padx=30)

        self.display_entries_button = tk.Button(center_frame, text="Display Entries", command=self.display_entries,
                                                bg="#795548", fg="white", padx=10, pady=5, width=15, height=1, bd=2, relief=tk.FLAT)
        self.display_entries_button.grid(row=2, column=2, pady=10, padx=30)

        self.delete_button = tk.Button(center_frame, text="Delete", command=self.delete_info,
                                       bg="#795548", fg="white", padx=10, pady=5, width=15, height=1, bd=2, relief=tk.FLAT)
        self.delete_button.grid(row=2, column=3, pady=10, padx=30)

        self.update_button = tk.Button(center_frame, text="Update", command=self.update_info,
                                       bg="#795548", fg="white", padx=10, pady=5, width=15, height=1, bd=2, relief=tk.FLAT)
        self.update_button.grid(row=2, column=4, pady=10, padx=30)

        self.generate_bill_button = tk.Button(center_frame, text="Generate Bill", command=self.generate_bill,
                                              bg="#795548", fg="white", padx=10, pady=5, width=15, height=1, bd=2, relief=tk.FLAT)
        self.generate_bill_button.grid(row=2, column=5, pady=10, padx=30)
    ...
    def create_treeview(self):
        ...
        tree_frame = tk.Frame(self.root, bg="#d3d3d3")
        tree_frame.grid(row=1, column=0, sticky="nsew")

        self.root.grid_rowconfigure(1, weight=1)
        self.root.grid_columnconfigure(0, weight=1)

        self.tree = ttk.Treeview(tree_frame, columns=("ID", "Name", "Entry date", "Entry time", "Exit date", "Exit time", "Bill"), show="headings")
        ...
        self.tree.grid(row=0, column=0, padx=0, pady=10, sticky="nsews")
    ...
    def add_info(self):
        ...
        add_entry_exit_button = ttk.Button(self.customer_details_window, text="Add Entry/Exit", style="TButton", command=self.add_entry_exit)
    ...
    def update_info(self):
        ...
        if customer_details:
            ...
            guest_name_label.grid(row=0, column=0, padx=10, pady=10)
            guest_name_label.config(font=("Helvetica", 12, "bold"), foreground="black")
            ...
            entry_date_label.grid(row=1, column=0, padx=10, pady=10)
            entry_date_label.config(font=("Helvetica", 12, "bold"), foreground="black")
            ...
            entry_time_label.grid(row=2, column=0, padx=10, pady=10)
            entry_time_label.config(font=("Helvetica", 12, "bold"), foreground="black")
            ...
            exit_date_label.grid(row=3, column=0, padx=10, pady=10)
            exit_date_label.config(font=("Helvetica", 12, "bold"), foreground="black")
            ...
            exit_time_label.grid(row=4, column=0, padx=10, pady=10)
            exit_time_label.config(font=("Helvetica", 12, "bold"), foreground="black")
            ...
            update_button = ttk.Button(self.edit_window, text="Update", style="TButton", command=lambda: self.update_customer_details(customer_id))
